...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Update product information and details</p>
                </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('products.put', $product->id) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" 
                               ...
                               min="0"
                               step="0.01"
                               class="mt-1 block w-full pl-12 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('price') border-red-300 @enderror"
                               placeholder="0.00"
                               required>
                    </div>
                    @error('price')
        ...
        <div class="mt-8 bg-white shadow rounded-lg p-6">
            ...
            <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                    <dt class="text-sm font-medium text-gray-500">Current Category</dt>
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            if (!preview) {
                ...
                preview.className = 'h-20 w-20 object-cover rounded-lg border border-gray-300 mt-2';
                document.querySelector('input[name="image"]').parentNode.appendChild(preview);
            }
